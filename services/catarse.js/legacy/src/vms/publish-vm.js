...
const subTerms = project => [
    ...
    m('.w-col.w-col-11', [
        ...
        m('div', [
            ...
            m("a.alt-link[href='http://suporte.trendnotion.com:3000/hc/pt-br/articles/202387638-Diretrizes-para-cria%C3%A7%C3%A3o-de-projetos'][target='_blank']",
                'Regras do Jogo'
            ),
            ' e ',
            m("a.alt-link[href='http://www.trendnotion.com:3000/terms-of-use'][target='_blank']",
                'Termos de Uso'
            ),
            '.'
        ])
