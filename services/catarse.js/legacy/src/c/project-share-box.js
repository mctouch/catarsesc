    ...
    view: function(ctrl, args) {
        return m('.pop-share.fontcolor-primary', {
            ...
            m('.w-widget.w-widget-twitter.w-hidden-small.w-hidden-tiny.share-block', [
                m(`iframe[allowtransparency="true"][width="120px"][height="22px"][frameborder="0"][scrolling="no"][src="//platform.twitter.com/widgets/tweet_button.8d007ddfc184e6776be76fe9e5e52d69.en.html#_=1442425984936&count=horizontal&dnt=false&id=twitter-widget-1&lang=en&original_referer=https%3A%2F%2Fwww.trendnotion.com%2Fpt%2F${args.project().permalink}&size=m&text=Confira%20o%20projeto%20${args.project().name}%20no%20%40catarse&type=share&url=https%3A%2F%2Fwww.trendnotion.com%2Fpt%2F${args.project().permalink}%3Fref%3Dtwitter%26utm_source%3Dtwitter.com%26utm_medium%3Dsocial%26utm_campaign%3Dproject_share&via=catarse"]`)
            ]),
            m('a.w-hidden-small.widget-embed.w-hidden-tiny.fontsize-small.link-hidden.fontcolor-secondary[href="javascript:void(0);"]', {
                ...
                m('.w-form', [
                    m(`input.w-input[type="text"][value="<iframe frameborder="0" height="340px" src="https://www.trendnotion.com/pt/projects/${args.project().project_id}/embed" width="300px" scrolling="no"></iframe>"]`)
                ]),
                m('.card-embed', [
            ...
            args.project().permalink ? m.component(facebookButton, {
                mobile: true,
                url: `https://www.trendnotion.com/${args.project().permalink}?ref=facebook&utm_source=facebook.com&utm_medium=social&utm_campaign=project_share`
            }) : '',
            m(`a.w-hidden-main.w-hidden-medium.btn.btn-medium.btn-tweet.u-marginbottom-20[href="https://twitter.com/intent/tweet?text=Acabei%20de%20apoiar%20o%20projeto%20${encodeURIComponent(args.project().name)}%20https://www.trendnotion.com/${args.project().permalink}%3Fref%3Dtwitter%26utm_source%3Dtwitter.com%26utm_medium%3Dsocial%26utm_campaign%3Dproject_share"][target="_blank"]`, [
                m('span.fa.fa-twitter'), ' Tweet'
            ]),
            m('a.w-hidden-main.w-hidden-medium.btn.btn-medium[data-action="share/whatsapp/share"]', {
                href: `whatsapp://send?text=${encodeURIComponent(`https://www.trendnotion.com/${args.project().permalink}/?ref=whatsapp&utm_source=whatsapp&utm_medium=social&utm_campaign=project_share`)}`
