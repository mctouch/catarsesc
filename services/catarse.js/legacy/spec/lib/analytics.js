...
window.CatarseAnalytics = window.CatarseAnalytics || (function(){
  ...
  */
  ...
  var ctrse_sid=(function(cookie){
    ...
    cookie.set('ctrse_sid',sid,180,'/',false,'.trendnotion.com:3000');
    return sid;
  })(monster);
  ...
  try {
    ...
    var origin = (function(request,cookie) {
      ...
      cookie.set('ctrse_origin',JSON.stringify(o),180,'/',false,'.trendnotion.com:3000');
      return o;
  ...
  function _getApiHost() {
    ...
    var el=document.getElementById('api-host-moments');
