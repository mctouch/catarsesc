...
SitemapGenerator::Sitemap.create do
  ...
  # Outros sites
  add '/', host: 'http://suporte.trendnotion.com:3000/'
  add '/', host: 'http://pesquisa.trendnotion.com:3000/'
  add '/guia-financiamento-coletivo', host: 'http://fazum.trendnotion.com:3000'
